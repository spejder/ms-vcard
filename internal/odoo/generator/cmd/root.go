...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&database, "database", "d", "postgres", "the instance database")
	...
	rootCmd.PersistentFlags().StringVar(&url, "url", "https://api.hypeschools.com", "the url of your odoo instance")
	rootCmd.PersistentFlags().StringVarP(&destFolder, "dest", "o", "/Users/longnguyen/project/src/gank/go-odoo", "the destination of generated models")
